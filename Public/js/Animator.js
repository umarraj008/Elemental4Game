class Animator {
    ...
    switchAnimation(to, playerAnimator) {
        switch (to) {
            case "idle":
            ...
            case "attack1":
                ...
                window.setTimeout(function() {playerAnimator.switchAnimation("damage");}, this.animations.damageTime1);
                break;
            case "attack2":
                this.animations.attack2.counter = 0;
                this.animations.attack2.offX = 0;
                this.currentAnimation = "attack2";
                window.setTimeout(function() {playerAnimator.switchAnimation("damage");}, this.animations.damageTime2);
                break;
            case "attack3":
                this.animations.attack3.counter = 0;
                this.animations.attack3.offX = 0;
                this.currentAnimation = "attack3";
                window.setTimeout(function() {playerAnimator.switchAnimation("damage");}, this.animations.damageTime3);
                break; 
            case "ultimate":
                this.animations.ultimate.counter = 0;
                this.animations.ultimate.offX = 0;
                this.currentAnimation = "ultimate";
                window.setTimeout(function() {playerAnimator.switchAnimation("damage");}, this.animations.damageTime4);
                break;
            case "wait":
